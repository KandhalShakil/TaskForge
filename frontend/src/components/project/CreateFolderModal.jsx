...
import { X, FolderPlus, Info, Check } from 'lucide-react'
...
export default function CreateFolderModal({ workspace, defaultSpaceId, onClose, onCreated }) {
  ...
  const onSubmit = async (data) => {
    ...
    if (!data.space) return toast.error('Please select a space')
      ...
      >
        ...
        <div className="p-6 border-b border-white/5 flex items-center justify-between shrink-0">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h2 className="text-xl font-black text-white tracking-tight leading-none">New Folder</h2>
              <p className="text-[10px] font-bold text-slate-500 uppercase tracking-widest mt-1.5 opacity-60">Company Architecture</p>
            </div>
          </div>
        ...
        <div className="overflow-y-auto no-scrollbar flex-1">
          ...
          <div className="flex items-center gap-3 p-4 bg-primary-500/[0.03] rounded-2xl border border-primary-500/10">
            ...
            <p className="text-[10px] text-slate-400 font-medium leading-relaxed uppercase tracking-wider">
              Folders are high-level containers used to organize related project lists.
            </p>
          </div>
