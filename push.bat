...
git commit -m "Fix database connection and query issues causing instability , Improve UI responsiveness across devices , Implement real-time chat functionality with message handling" 2>nul
